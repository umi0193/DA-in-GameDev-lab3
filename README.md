...
Ход работы:(продолжение) 
20) После настройки и сортировки всех файлов приступим к упаковке игры: file--->build settings, выбираем WEBGL, устанавливаем пакет, далее ставим пару настроек, выбираем папку и нажимаем"Build and run". После завершения открывается [веб-страница с нашей игрой]()
...
23) Нужно выбрать шаблон, который будет распространен на весь проект: Resolution and presentation ---> [Plugin YG](), далее в новую папку билдим проект. 
24) 
